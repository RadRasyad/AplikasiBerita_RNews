package com.example.rnews.ui.home.categoryfragment.sport
...
import com.example.rnews.databinding.FragmentSportBinding
...
class SportFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sportViewModel = ViewModelProvider(requireActivity())[SportViewModel::class.java]
        sportViewModel.setNews()
        sportViewModel.getNews().observe(requireActivity(), {
            if (it!=null) {
                adapter.setList(it)
